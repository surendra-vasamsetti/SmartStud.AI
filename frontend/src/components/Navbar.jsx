        ...
        {open && (
          <div className="absolute right-0 mt-2 w-64 sm:w-72 bg-white dark:bg-gray-800 rounded-xl shadow-lg border dark:border-gray-700 z-[100] max-h-[calc(100vh-5rem)] overflow-y-auto">
            ...
            <div className="border-t dark:border-gray-700">
              <button className="w-full flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2.5 sm:py-3 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 text-sm sm:text-base transition-colors">
